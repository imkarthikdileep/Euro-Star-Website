        ...
        <main className="min-h-screen pt-32 pb-20 px-4 md:px-6 container mx-auto relative">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-white/95 border border-slate-100 shadow-sm p-8 md:p-12 max-w-4xl mx-auto space-y-8 z-10 dark:bg-black/80 dark:border-white/10 dark:text-slate-200">
                <section className="space-y-4">
                    <h2 className="text-2xl font-bold font-michroma text-slate-900 dark:text-white">1. Information We Collect</h2>
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl font-bold font-michroma text-slate-900 dark:text-white">2. How We Use Your Information</h2>
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl font-bold font-michroma text-slate-900 dark:text-white">3. Cookies</h2>
                    <p className="text-muted-foreground leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl font-bold font-michroma text-slate-900 dark:text-white">4. Contact Us</h2>
                    <p className="text-muted-foreground leading-relaxed">
