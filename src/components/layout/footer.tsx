      ...
      <div className="container mx-auto px-4 md:px-6 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-4">
            <Link href={`mailto:${email}`} aria-label="Send an email">
            ...
            <Link href={`https://wa.me/${phoneNumber}`} target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:text-accent transition-colors" viewBox="0 0 24 24" fill="currentColor">
